...
func (a *App) routes() []appRoute {
	return []appRoute{
		...
		subtree("/api/editable-files", a.handleEditableFiles),
		subtree("/api/image-tags", a.handleImageTags),
		subtree("/api/backup", a.handleBackup),
		subtree("/api/oauth", a.handleOAuth),
